...
def random_walk_2(col_pre, row_pre, scale=20, scale_factor=3, dist='nom'):
    ...
    if dist == 'uni':
        ...
        return x_next, y_next
def make_triangle_pos(col_pre_pos, row_pre_pos, triangle_radius=60, do_print=False):
    """
...
def make_triangle_pos_inverse(col_pre_pos, row_pre_pos, triangle_radius=60, do_print=False):
    """
    閾値を上回った座標を中心とした3点の座標
