...
def log_random_walk(random_col_list, random_row_list, random_signal_list, filename):
...
def log_triangle(col_center_list, row_center_list, len_over_list_list, filename):
