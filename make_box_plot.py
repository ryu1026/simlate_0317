...
ax.set_xlabel('計測回数 [回]', fontname='MS Gothic', fontsize=14)
ax.set_title('計測回数の箱ひげ図', fontname='MS Gothic', fontsize=16)
...
ax.set_yticklabels(['3秒経過後', '3点計測時', 'ランダム時'], fontname='MS Gothic', fontsize=14)
plt.tight_layout()
plt.show()